...
class wamr_transaction {
    ...
    constructor(mid: number, time: number, cb: (resp: wamr_response | null) => void) {
        this.mid = mid;
        this.time = time;
        this.cb = cb;
    }
...
var g_trans_timer: timer.user_timer | null = null;
...
function do_request(req: wamr_request, cb: (resp: wamr_response | null) => void): void {
...
export function post(url: string, payload: ArrayBuffer, payload_len: number, tag: string,
                     cb: (resp: wamr_response | null) => void): void {
...
export function on_response(buffer_offset: i32, size: i32): void {
    ...
    if (g_trans_timer != null && trans != null) {
