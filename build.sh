...
CURR_DIR=$PWD
WAMR_APP_FRAMEWORK=${CURR_DIR}/dependencies/wamr-app-framework
WAMR_DIR=${PWD}/dependencies/wasm-micro-runtime
OUT_DIR=${PWD}/out

IWASM_ROOT=${WAMR_DIR}/core/iwasm
APP_FRAMEWORK_DIR=${WAMR_APP_FRAMEWORK}/app-framework
